...
class Api {
	...
	protected $routes = [
		...
		'POST'   => [
			...
			'analyze-headline'                                       => [ 'callback' => [ 'Analyze', 'analyzeHeadline' ], 'access' => [ 'aioseo_page_analysis', 'aioseo_seo_analysis_settings' ] ],
			...
			'truseo/terms/(?P<termId>[\d]+)'                         => [ 'callback' => [ 'PostsTerms', 'updateTermTruseo' ], 'access' => 'aioseo_page_analysis' ],

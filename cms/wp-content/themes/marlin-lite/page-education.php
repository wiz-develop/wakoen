...
<div class="education_page">
	...
	<div id="life_motion">
		<div class="education_life">
			<p class="edulife_title">
				和光園での生活
			</p>
...
<div class="edu_area">
	<p class="edulife_title">教育</div>
	<p class="eduarea_wr">和光園の教育プログラムでは、知的好奇心と、小学校就学以降の学習を支える、レディネスを大切にしています。<br>子どもたちの「あ！」「なんでかな？？」「しってる！」「ふしぎ！」「やってみよ！」「きいてきいて」があふれる毎日です。</p>
</div>
	

	<p class="edulife_title">専門講師</p>
<div class="eduarea_wr">
	<p>
	乳幼児の教育は、目先の結果のみを期待しているのではなく、生涯にわたる学習の基礎を作ること、「後伸びする力」を培うことを重視しています。<br>
	身体感覚を伴う多様な活動を経験することによって、豊かな感性を養うとともに、生涯にわたる学習意欲や学習態度の基礎となる好奇心や探究心を培い、また、小学校以降における教科の内容等について実感を伴って深く理解できることにつながる「学びの芽生え」を育んでいます。<br>
	正課指導は、様々な体験ができるよう、専任の先生方と指導計画を共有しながら実施しています。
	</p>
	<div class="more-link text-center">
		<a href="/educationnurture/lesson/#regular_course">
			<button class="rounded-pill">
				<p class="mb-0">正課一覧<i class="fa fa-arrow-right"></i></p>
			</button>
		</a>
	</div>
</div>
...
<div class="eduarea_wr">
	...
	<div class="more-link text-center">
		<a href="/educationnurture/lesson/#extracurricular">
			<button class="rounded-pill">
				<p class="mb-0">課外教室一覧<i class="fa fa-arrow-right"></i></p>
			</button>
		</a>
	</div>
</div>
...
<div class="education_page">
<div class="education_eating">
			<div class="eat_area1">
			<p class="edulife_title">食事</p>
			<p class="eat_write">食生活は育児の原点であり、何よりも大切にしたいことです。<br>
			子どもたちには、</p>
			<p class="eat_write1">食べるのが楽しい</p>
			<p class="eat_write3">しっかりかんで、味わって美味しく食べる</p>
...
<p class="allergy_write2">食物アレルギーなどのお子さまには、除去食や、段階の調整など細やかに対応しております。<br>
「なかよし給食」をはじめとして、保護者の方と栄養士、保育士が連携しながら、給食をすすめています。</p>
</div>
</div>
...
<!-- コメント -->
		...
		<div class="education_flow">
			<p class="edulife_title">1日の流れ</p>
			<div class="day-flow">
			<div class="infant_flow">
			<p class="infant_title">乳児期&nbsp;(0歳児~2歳児)</p>
			<p class="baby_time07">7：00 開園</p>
			<p class="open_time">順次登園</p>
			<br>
...
遊び" class="gosui_pic">
			...
			<p class ="baby_time07">16:00〜</p>
			<p class="infant_fort">順次降園</p>
			</div>
			...
			<p class="youji_title">幼児期&nbsp;(3歳児~5歳児)</p>
			<p class="child_time07">7：00 開園</p>
			<p class="youji_seven">順次登園</p>
...
遊び" class="youji_eat">
			...
			<p class="youji_kadai">課題あそび<br>(4・5歳児クラス)
...
<div class="education_flowsp">
			<p class="edulife_title">1日の流れ</p>
		<div class="infant_flowsp">
...
一日" class="time_clocksp">
		...
		<div class="years_block">
			...
			<p class="year_event">身体測定、災害避難訓練を毎月行っております。<br>
				お誕生日のお子さまは、当日にバッチをつけて、園中でお祝いをしています。</p>
			<p class="education_clear">
			</div>
